			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="assignTo-label" class="property-label"><g:message code="task.assignTo.label" default="Assign To" /></span>
						...
						<span class="property-value" aria-labelledby="assignTo-label"><g:link controller="tekUser" action="show" id="${taskInstance?.assignTo?.id}">${taskInstance?.assignTo?.encodeAsHTML()}</g:link></span>
